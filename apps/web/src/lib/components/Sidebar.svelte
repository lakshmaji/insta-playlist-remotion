...
<div class="bg-white dark:bg-[#1a1a1a] p-0 h-full overflow-y-auto flex flex-col text-gray-700 dark:text-gray-300 sidebar-content">
	<!-- Header Section with Title -->
	<div class="px-4 py-3 border-b border-gray-200 dark:border-gray-800/50">
		<div class="flex items-center justify-between">
			<h2 class="text-sm font-medium text-gray-600 dark:text-gray-400">Bookmarks Manager</h2>
			<button class="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition-all" title="Settings">
	...
	<div class="px-3 py-3 space-y-1.5">
		<button 
			...
			class="flex items-center gap-2 px-3 py-2 w-full text-left text-sm rounded-md hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-all">
